...
KEYWORDS = {
    "A": [
        ...
        # 혜택정보 (government assistance programs) + 신규 세부주제
        "medicare savings programs qmb slmb qi eligibility explained",
        "medicare extra help low income subsidy how to apply",
        "medicaid spend down rules for nursing home eligibility",
        "state pharmaceutical assistance programs for seniors",
        "how to appeal a medicare advantage plan denial",
        "medicare coverage for diabetic supplies and insulin cost cap",
        "medicare coverage for durable medical equipment wheelchairs walkers",
        "how snap food stamps work for seniors on fixed income",
        "liheap energy assistance program for seniors how to apply",
        "va aid and attendance benefit for wartime veterans explained",
        "property tax exemption programs for senior homeowners",
        "medicare coverage for telehealth visits explained",
        "how to find free or low cost dental care for seniors",
        "medicare coverage for weight loss drugs for seniors",
        "senior discount prescription drug cards without insurance",
    ],
    "B": [
        ...
        # 혜택정보 (government assistance programs) + 신규 세부주제
        "supplemental security income ssi eligibility for seniors",
        "how to apply for social security disability after 60",
        "veterans pension benefit for low income wartime veterans",
        "how divorced spouses claim social security benefits",
        "widow and widower social security benefits explained",
        "how to reduce required minimum distribution tax with qcd",
        "medicaid asset protection trust for married couples",
        "how social security survivor benefits work for children",
        "best budgeting apps for retirees on fixed income",
        "how to negotiate medical debt after retirement",
        "property tax deferral programs for retirees",
        "how to claim social security for an ex spouse",
        "retirement savings catch up strategies after age 60",
        "how pension income affects social security taxation",
        "elder financial abuse warning signs and protection",
    ],
    "C": [
        ...
        # 혜택정보 (government assistance programs) + 신규 세부주제
        "family caregiver support programs and paid caregiver benefits",
        "va home modification grants for disabled veterans",
        "respite care options for family caregivers of seniors",
        "adult day care programs cost and benefits for seniors",
        "senior transportation services for those who no longer drive",
        "how to find a geriatric care manager and what they do",
        "best senior travel insurance for pre-existing conditions",
        "assistive technology for seniors with vision loss",
        "how to talk to aging parents about giving up driving",
        "home sharing programs for seniors to reduce isolation",
        "weatherization assistance program for low income seniors",
        "how to childproof a home for grandparents raising grandchildren",
        "meal delivery programs for homebound seniors medicare coverage",
        "senior companion programs to combat loneliness",
    ],
    "D": [
        # 식단 / 영양
        ...
        "how to manage polypharmacy and reduce medication risks",
        "signs of depression in seniors often mistaken for aging",
        "hearing loss and dementia risk connection explained",
        "how to prevent urinary tract infections in elderly",
        "best sleep aids for seniors safe alternatives to sedatives",
        "vision changes in seniors when to see an ophthalmologist",
        "how grief affects health in seniors after losing a spouse",
        "flu and pneumonia vaccine guidelines for seniors over 65",
        "how to manage chronic pain in seniors without opioids",
        "cognitive exercises to keep the brain sharp after 65",
        "signs of dehydration in elderly and how to prevent it",
        "how loneliness affects senior health outcomes",
        "benefits of gardening for seniors physical and mental health",
        "how to choose a primary care doctor after moving in retirement",
    ],
}
